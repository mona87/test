...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stepsForm = __webpack_require__(161);

	var _stepsForm2 = _interopRequireDefault(_stepsForm);

	var _calculator = __webpack_require__(162);
		...
		_createClass(Form, [{
			...
			value: function getValues() {
				if (this.state.agentNum === null) {
					...
					this.setState({ trainingDaysNum: (0, _numeral2.default)().unformat(this.refs.q2.value) });
				} else if (this.state.churnNum === null) {
					//add val to navbar
					// $('#churn').html($('#q3').val());
					//get churn days
					this.setState({ churnNum: (0, _numeral2.default)().unformat(this.refs.q3.value) });
				} else if (costPerHour === null) {
					//add val to navbar
					// $('#cost').html($('#q4').val());
					//get cost per hour
					this.setState({ costPerHour: (0, _numeral2.default)().unformat(this.refs.q4.value) });
					(0, _calculator2.default)(this.state.agentNum, this.state.trainingDaysNum, this.state.churnNum, this.state.costPerHour);
				}
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'h1',
							null,
							'Calculate Your Emotional Connection ROI'
						),
						_react2.default.createElement(
							'h2',
							null,
					...
					_react2.default.createElement(
						'form',
						{ id: 'theForm', className: 'simform', autoComplete: 'off' },
						_react2.default.createElement(
							'div',
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										...
										_react2.default.createElement(
											'label',
											{ htmlFor: 'q1' },
											'Whats your total agent count?'
										)
									),
									_react2.default.createElement('input', { ref: 'q1', id: 'q1', name: 'q1', type: 'text' })
								),
								_react2.default.createElement(
									'li',
									null,
									...
									_react2.default.createElement('input', { ref: 'q2', id: 'q2', name: 'q2', type: 'text' })
								),
								_react2.default.createElement(
									'li',
									null,
									_react2.default.createElement(
										...
										_react2.default.createElement(
											'label',
											{ htmlFor: 'q3' },
											'What is your annual churn?'
										)
									),
									_react2.default.createElement('input', { ref: 'q3', id: 'q3', name: 'q3', type: 'text' })
								),
								_react2.default.createElement(
									'li',
									null,
									_react2.default.createElement(
										...
										_react2.default.createElement(
											'label',
											{ htmlFor: 'q4' },
											'What is your agent fully loaded cost per hr?'
										)
									),
									_react2.default.createElement('input', { ref: 'q4', id: 'q4', name: 'q4', type: 'text' })
								)
							),
							_react2.default.createElement(
								'button',
							...
							_react2.default.createElement(
								'div',
								{ className: 'controls' },
								_react2.default.createElement('button', { className: 'next', onClick: this.getValues.bind() }),
