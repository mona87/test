		        ...
		        $('.bgImg').css({"position": "absolute"});
		        	//for ie10 and up
			         ...
			         // if (Object.hasOwnProperty.call(window, "ActiveXObject") && !window.ActiveXObject) {
	    				$('.wrapper').addClass('ie');
	    				$('#page2').css({ 'min-height':'3210px','transform': "translateY(-700px)",'position':'relative', "margin-bottom":"-700px","left":"0",'top':'0'});
		...
		$('.open').click(function() {
		    ...
		    if ($('#page1').hasClass('toggled')) {
		        ...
		        $('.arrow-down').css({"margin-bottom":"5px", "transform": "rotate(180deg)"});
		        	 if(isIE11){
			  	    // $('.wrapper').addClass('ie');
			  	   $('#page2').css({ 'min-height':'3210px','transform': "translateY(-700px)",'position':'relative', "margin-bottom":"-700px","left":"0"});
    				// $('#page2').css({'position':'relative','margin-bottom':'-700px'});
